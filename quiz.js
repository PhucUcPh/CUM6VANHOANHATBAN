...
function submitQuiz() {
    ...
    if (!answeredAll) {
        if(!confirm("Bạn chưa trả lời hết tất cả các câu hỏi. Bạn có muốn nộp bài không?")) {
            return;
        }
    }
    ...
    let message = "";
    if (score === quizData.length) message = "Xuất sắc! Bạn là chuyên gia về Nhật Bản.";
    else if (score > quizData.length / 2) message = "Tuyệt vời! Bạn có kiến thức khá về Nhật Bản.";
